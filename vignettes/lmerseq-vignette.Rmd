...
```{r}
 ...
 model_sum <- lmerSeq.summary(lmerSeq_results = fit.lmerSeq,
                              ...
                              sort_results = T)
names(model_sum)
head(model_sum$summary_table)
```
Along with information about the function call, the resulting summary object contains a list of genes with singular models, and a summary table. For each gene, the summary table displays the model estimate, standard error, degree of freedom, t-value, and raw and adjusted p-values. Genes with singular models are excluded from the summary table.
